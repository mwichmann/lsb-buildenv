...
__asm__(".globl __ctype_tolower; .pushsection .data; .type __ctype_tolower,@object; .size __ctype_tolower, 8; __ctype_tolower: .long 0; .popsection");
...
__asm__(".globl _sys_errlist; .pushsection .data; .type _sys_errlist,@object; .size _sys_errlist, 1000; _sys_errlist: .long 0; .popsection");
