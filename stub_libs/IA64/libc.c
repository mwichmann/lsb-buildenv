...
__asm__(".globl __ctype_tolower; .section .data; .type __ctype_tolower,@object; .size __ctype_tolower, 8; __ctype_tolower: .long 0; .section .text");
__asm__(".comm __ctype_toupper,8");
__asm__(".globl __daylight; .section .data; .type __daylight,@object; .size __daylight, 4; __daylight: .long 0; .section .text");
__asm__(".globl __environ; .section .data; .type __environ,@object; .size __environ, 8; __environ: .long 0; .section .text");
__asm__(".globl __timezone; .section .data; .type __timezone,@object; .size __timezone, 8; __timezone: .long 0; .section .text");
__asm__(".globl __tzname; .section .data; .type __tzname,@object; .size __tzname, 16; __tzname: .long 0; .section .text");
__asm__(".weak _environ; _environ = __environ");
__asm__(".comm _nl_msg_cat_cntr,4");
__asm__(".globl _sys_errlist; .section .data; .type _sys_errlist,@object; .size _sys_errlist, 1000; _sys_errlist: .long 0; .section .text");
