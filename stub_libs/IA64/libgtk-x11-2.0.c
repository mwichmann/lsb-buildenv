...
void gtk_list_get_type() {} ;
void gtk_list_item_get_type() {} ;
...
void gtk_main_level() {} ;
void gtk_main_quit() {} ;
void gtk_marshal_BOOLEAN__POINTER() {} ;
void gtk_marshal_BOOLEAN__POINTER_INT_INT() {} ;
void gtk_marshal_BOOLEAN__POINTER_INT_INT_UINT() {} ;
void gtk_marshal_BOOLEAN__POINTER_POINTER_INT_INT() {} ;
void gtk_marshal_BOOLEAN__POINTER_STRING_STRING_POINTER() {} ;
void gtk_marshal_BOOLEAN__VOID() {} ;
void gtk_marshal_ENUM__ENUM() {} ;
void gtk_marshal_INT__POINTER() {} ;
void gtk_marshal_INT__POINTER_CHAR_CHAR() {} ;
void gtk_marshal_VOID__ENUM_FLOAT() {} ;
void gtk_marshal_VOID__ENUM_FLOAT_BOOLEAN() {} ;
void gtk_marshal_VOID__INT_INT() {} ;
void gtk_marshal_VOID__INT_INT_POINTER() {} ;
void gtk_marshal_VOID__POINTER_INT() {} ;
void gtk_marshal_VOID__POINTER_INT_INT_POINTER_UINT_UINT() {} ;
void gtk_marshal_VOID__POINTER_POINTER() {} ;
void gtk_marshal_VOID__POINTER_POINTER_POINTER() {} ;
void gtk_marshal_VOID__POINTER_POINTER_UINT_UINT() {} ;
void gtk_marshal_VOID__POINTER_STRING_STRING() {} ;
void gtk_marshal_VOID__POINTER_UINT() {} ;
void gtk_marshal_VOID__POINTER_UINT_ENUM() {} ;
void gtk_marshal_VOID__POINTER_UINT_UINT() {} ;
void gtk_marshal_VOID__STRING_INT_POINTER() {} ;
void gtk_marshal_VOID__UINT_POINTER_UINT_ENUM_ENUM_POINTER() {} ;
void gtk_marshal_VOID__UINT_POINTER_UINT_UINT_ENUM() {} ;
void gtk_marshal_VOID__UINT_STRING() {} ;
...
void gtk_paned_add1() {} ;
void gtk_paned_add2() {} ;
void gtk_paned_compute_position() {} ;
...
__asm__(".globl gtk_binary_age; .pushsection .data; .type gtk_binary_age,@object; .size gtk_binary_age, 0; gtk_binary_age: .long 0; .popsection");
__asm__(".globl gtk_debug_flags; .pushsection .data; .type gtk_debug_flags,@object; .size gtk_debug_flags, 0; gtk_debug_flags: .long 0; .popsection");
__asm__(".globl gtk_interface_age; .pushsection .data; .type gtk_interface_age,@object; .size gtk_interface_age, 0; gtk_interface_age: .long 0; .popsection");
__asm__(".globl gtk_major_version; .pushsection .data; .type gtk_major_version,@object; .size gtk_major_version, 0; gtk_major_version: .long 0; .popsection");
__asm__(".globl gtk_micro_version; .pushsection .data; .type gtk_micro_version,@object; .size gtk_micro_version, 0; gtk_micro_version: .long 0; .popsection");
__asm__(".globl gtk_minor_version; .pushsection .data; .type gtk_minor_version,@object; .size gtk_minor_version, 0; gtk_minor_version: .long 0; .popsection");
