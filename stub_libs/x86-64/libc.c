...
__asm__(".globl __ctype_tolower; .pushsection .data; .type __ctype_tolower,@object; .size __ctype_tolower, 0; __ctype_tolower: .long 0; .popsection");
...
__asm__(".globl __environ; .pushsection .data; .type __environ,@object; .size __environ, 0; __environ: .long 0; .popsection");
__asm__(".globl __timezone; .pushsection .data; .type __timezone,@object; .size __timezone, 8; __timezone: .long 0; .popsection");
__asm__(".globl __tzname; .pushsection .data; .type __tzname,@object; .size __tzname, 0; __tzname: .long 0; .popsection");
