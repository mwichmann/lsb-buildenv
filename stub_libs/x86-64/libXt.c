...
__asm__(".globl XtCXtToolkitError; .pushsection .data; .type XtCXtToolkitError,@object; .size XtCXtToolkitError, 0; XtCXtToolkitError: .long 0; .popsection");
__asm__(".globl XtShellStrings; .pushsection .data; .type XtShellStrings,@object; .size XtShellStrings, 0; XtShellStrings: .long 0; .popsection");
__asm__(".globl XtStrings; .pushsection .data; .type XtStrings,@object; .size XtStrings, 0; XtStrings: .long 0; .popsection");
__asm__(".globl _XtInheritTranslations; .pushsection .data; .type _XtInheritTranslations,@object; .size _XtInheritTranslations, 0; _XtInheritTranslations: .long 0; .popsection");
...
__asm__(".globl overrideShellClassRec; .pushsection .data; .type overrideShellClassRec,@object; .size overrideShellClassRec, 0; overrideShellClassRec: .long 0; .popsection");
...
__asm__(".globl rectObjClass; .pushsection .data; .type rectObjClass,@object; .size rectObjClass, 0; rectObjClass: .long 0; .popsection");
__asm__(".globl rectObjClassRec; .pushsection .data; .type rectObjClassRec,@object; .size rectObjClassRec, 0; rectObjClassRec: .long 0; .popsection");
__asm__(".globl sessionShellClassRec; .pushsection .data; .type sessionShellClassRec,@object; .size sessionShellClassRec, 0; sessionShellClassRec: .long 0; .popsection");
__asm__(".globl sessionShellWidgetClass; .pushsection .data; .type sessionShellWidgetClass,@object; .size sessionShellWidgetClass, 8; sessionShellWidgetClass: .long 0; .popsection");
__asm__(".globl shellClassRec; .pushsection .data; .type shellClassRec,@object; .size shellClassRec, 0; shellClassRec: .long 0; .popsection");
__asm__(".globl shellWidgetClass; .pushsection .data; .type shellWidgetClass,@object; .size shellWidgetClass, 8; shellWidgetClass: .long 0; .popsection");
__asm__(".globl topLevelShellClassRec; .pushsection .data; .type topLevelShellClassRec,@object; .size topLevelShellClassRec, 0; topLevelShellClassRec: .long 0; .popsection");
__asm__(".globl topLevelShellWidgetClass; .pushsection .data; .type topLevelShellWidgetClass,@object; .size topLevelShellWidgetClass, 8; topLevelShellWidgetClass: .long 0; .popsection");
__asm__(".globl transientShellClassRec; .pushsection .data; .type transientShellClassRec,@object; .size transientShellClassRec, 0; transientShellClassRec: .long 0; .popsection");
__asm__(".globl transientShellWidgetClass; .pushsection .data; .type transientShellWidgetClass,@object; .size transientShellWidgetClass, 8; transientShellWidgetClass: .long 0; .popsection");
__asm__(".globl widgetClass; .pushsection .data; .type widgetClass,@object; .size widgetClass, 0; widgetClass: .long 0; .popsection");
__asm__(".globl widgetClassRec; .pushsection .data; .type widgetClassRec,@object; .size widgetClassRec, 0; widgetClassRec: .long 0; .popsection");
__asm__(".globl wmShellClassRec; .pushsection .data; .type wmShellClassRec,@object; .size wmShellClassRec, 0; wmShellClassRec: .long 0; .popsection");
__asm__(".globl wmShellWidgetClass; .pushsection .data; .type wmShellWidgetClass,@object; .size wmShellWidgetClass, 8; wmShellWidgetClass: .long 0; .popsection");
