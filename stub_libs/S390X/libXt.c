...
__asm__(".globl XtCXtToolkitError; .section .data; .type XtCXtToolkitError,@object; .size XtCXtToolkitError, 8; XtCXtToolkitError: .long 0; .section .text");
...
__asm__(".globl applicationShellWidgetClass; .section .data; .type applicationShellWidgetClass,@object; .size applicationShellWidgetClass, 8; applicationShellWidgetClass: .long 0; .section .text");
__asm__(".globl compositeClassRec; .section .data; .type compositeClassRec,@object; .size compositeClassRec, 264; compositeClassRec: .long 0; .section .text");
__asm__(".globl compositeWidgetClass; .section .data; .type compositeWidgetClass,@object; .size compositeWidgetClass, 8; compositeWidgetClass: .long 0; .section .text");
__asm__(".globl constraintClassRec; .section .data; .type constraintClassRec,@object; .size constraintClassRec, 312; constraintClassRec: .long 0; .section .text");
__asm__(".globl constraintWidgetClass; .section .data; .type constraintWidgetClass,@object; .size constraintWidgetClass, 8; constraintWidgetClass: .long 0; .section .text");
__asm__(".globl coreWidgetClass; .section .data; .type coreWidgetClass,@object; .size coreWidgetClass, 8; coreWidgetClass: .long 0; .section .text");
__asm__(".globl objectClass; .section .data; .type objectClass,@object; .size objectClass, 8; objectClass: .long 0; .section .text");
__asm__(".globl objectClassRec; .section .data; .type objectClassRec,@object; .size objectClassRec, 224; objectClassRec: .long 0; .section .text");
__asm__(".globl overrideShellClassRec; .section .data; .type overrideShellClassRec,@object; .size overrideShellClassRec, 280; overrideShellClassRec: .long 0; .section .text");
__asm__(".globl overrideShellWidgetClass; .section .data; .type overrideShellWidgetClass,@object; .size overrideShellWidgetClass, 8; overrideShellWidgetClass: .long 0; .section .text");
__asm__(".globl rectObjClass; .section .data; .type rectObjClass,@object; .size rectObjClass, 8; rectObjClass: .long 0; .section .text");
__asm__(".globl rectObjClassRec; .section .data; .type rectObjClassRec,@object; .size rectObjClassRec, 224; rectObjClassRec: .long 0; .section .text");
__asm__(".globl sessionShellClassRec; .section .data; .type sessionShellClassRec,@object; .size sessionShellClassRec, 312; sessionShellClassRec: .long 0; .section .text");
__asm__(".globl sessionShellWidgetClass; .section .data; .type sessionShellWidgetClass,@object; .size sessionShellWidgetClass, 8; sessionShellWidgetClass: .long 0; .section .text");
__asm__(".globl shellClassRec; .section .data; .type shellClassRec,@object; .size shellClassRec, 272; shellClassRec: .long 0; .section .text");
__asm__(".globl shellWidgetClass; .section .data; .type shellWidgetClass,@object; .size shellWidgetClass, 8; shellWidgetClass: .long 0; .section .text");
__asm__(".globl topLevelShellClassRec; .section .data; .type topLevelShellClassRec,@object; .size topLevelShellClassRec, 296; topLevelShellClassRec: .long 0; .section .text");
__asm__(".globl topLevelShellWidgetClass; .section .data; .type topLevelShellWidgetClass,@object; .size topLevelShellWidgetClass, 8; topLevelShellWidgetClass: .long 0; .section .text");
__asm__(".globl transientShellClassRec; .section .data; .type transientShellClassRec,@object; .size transientShellClassRec, 296; transientShellClassRec: .long 0; .section .text");
__asm__(".globl transientShellWidgetClass; .section .data; .type transientShellWidgetClass,@object; .size transientShellWidgetClass, 8; transientShellWidgetClass: .long 0; .section .text");
__asm__(".globl widgetClass; .section .data; .type widgetClass,@object; .size widgetClass, 8; widgetClass: .long 0; .section .text");
__asm__(".globl widgetClassRec; .section .data; .type widgetClassRec,@object; .size widgetClassRec, 224; widgetClassRec: .long 0; .section .text");
__asm__(".globl wmShellClassRec; .section .data; .type wmShellClassRec,@object; .size wmShellClassRec, 280; wmShellClassRec: .long 0; .section .text");
__asm__(".globl wmShellWidgetClass; .section .data; .type wmShellWidgetClass,@object; .size wmShellWidgetClass, 8; wmShellWidgetClass: .long 0; .section .text");
