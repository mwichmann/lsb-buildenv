...
__asm__(".globl XtCXtToolkitError; .pushsection .data; .type XtCXtToolkitError,@object; .size XtCXtToolkitError, 8; XtCXtToolkitError: .long 0; .popsection");
...
__asm__(".globl constraintClassRec; .pushsection .data; .type constraintClassRec,@object; .size constraintClassRec, 8; constraintClassRec: .long 0; .popsection");
...
__asm__(".globl rectObjClassRec; .pushsection .data; .type rectObjClassRec,@object; .size rectObjClassRec, 224; rectObjClassRec: .long 0; .popsection");
__asm__(".globl sessionShellClassRec; .pushsection .data; .type sessionShellClassRec,@object; .size sessionShellClassRec, 312; sessionShellClassRec: .long 0; .popsection");
...
__asm__(".globl shellClassRec; .pushsection .data; .type shellClassRec,@object; .size shellClassRec, 272; shellClassRec: .long 0; .popsection");
...
__asm__(".globl topLevelShellClassRec; .pushsection .data; .type topLevelShellClassRec,@object; .size topLevelShellClassRec, 296; topLevelShellClassRec: .long 0; .popsection");
...
__asm__(".globl transientShellClassRec; .pushsection .data; .type transientShellClassRec,@object; .size transientShellClassRec, 296; transientShellClassRec: .long 0; .popsection");
...
__asm__(".globl widgetClass; .pushsection .data; .type widgetClass,@object; .size widgetClass, 8; widgetClass: .long 0; .popsection");
__asm__(".globl widgetClassRec; .pushsection .data; .type widgetClassRec,@object; .size widgetClassRec, 224; widgetClassRec: .long 0; .popsection");
__asm__(".globl wmShellClassRec; .pushsection .data; .type wmShellClassRec,@object; .size wmShellClassRec, 280; wmShellClassRec: .long 0; .popsection");
