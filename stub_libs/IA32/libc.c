...
__asm__(".globl __ctype_b_loc; .pushsection .data; .type __ctype_b_loc,@object; .size __ctype_b_loc, 113; __ctype_b_loc: .long 0; .popsection");
...
__asm__(".globl __ctype_tolower_loc; .pushsection .data; .type __ctype_tolower_loc,@object; .size __ctype_tolower_loc, 113; __ctype_tolower_loc: .long 0; .popsection");
__asm__(".comm __ctype_toupper,4");
__asm__(".globl __ctype_toupper_loc; .pushsection .data; .type __ctype_toupper_loc,@object; .size __ctype_toupper_loc, 113; __ctype_toupper_loc: .long 0; .popsection");
...
__asm__(".globl _sys_errlist; .pushsection .data; .type _sys_errlist,@object; .size _sys_errlist, 500; _sys_errlist: .long 0; .popsection");
