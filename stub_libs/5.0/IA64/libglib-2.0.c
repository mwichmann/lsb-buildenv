...
__asm__(".globl g_ascii_table; .pushsection .data; .type g_ascii_table,@object; .size g_ascii_table, 8; g_ascii_table: .long 0; .popsection");
__asm__(".globl g_child_watch_funcs; .pushsection .data; .type g_child_watch_funcs,@object; .size g_child_watch_funcs, 48; g_child_watch_funcs: .long 0; .popsection");
...
__asm__(".globl g_timeout_funcs; .pushsection .data; .type g_timeout_funcs,@object; .size g_timeout_funcs, 48; g_timeout_funcs: .long 0; .popsection");
__asm__(".globl g_utf8_skip; .pushsection .data; .type g_utf8_skip,@object; .size g_utf8_skip, 8; g_utf8_skip: .long 0; .popsection");
...
__asm__(".globl glib_mem_profiler_table; .pushsection .data; .type glib_mem_profiler_table,@object; .size glib_mem_profiler_table, 8; glib_mem_profiler_table: .long 0; .popsection");
