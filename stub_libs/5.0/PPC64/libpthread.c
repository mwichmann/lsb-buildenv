...
__asm__(".symver pthread_attr_setstack_depr_0,pthread_attr_setstack@GLIBC_2.3");
void pthread_attr_setstackaddr() {} ;
void pthread_attr_setstacksize() {} ;
void pthread_attr_setstacksize_depr_0() {} ;
__asm__(".symver pthread_attr_setstacksize_depr_0,pthread_attr_setstacksize@GLIBC_2.3");
