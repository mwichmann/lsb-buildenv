...
void gdk_cairo_set_source_pixmap() {} ;
...
void gdk_pixmap_foreign_new_for_screen() {} ;
...
void gdk_screen_get_rgba_colormap() {} ;
...
__asm__(".globl gdk_threads_lock; .pushsection .data; .type gdk_threads_lock,@object; .size gdk_threads_lock, 8; gdk_threads_lock: .long 0; .popsection");
__asm__(".globl gdk_threads_unlock; .pushsection .data; .type gdk_threads_unlock,@object; .size gdk_threads_unlock, 8; gdk_threads_unlock: .long 0; .popsection");
