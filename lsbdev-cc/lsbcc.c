...
usage(const char *progname) {
	printf("Usage %s:\n"
		...
		"\t                    environment setting)\n"
		"\t--lsb-forcefeatures\n"
		"\t                   Force setting -D flags for full feature set LSB\n"
		"\t                    supports\n"
		...
		"\t                    Module names will be appended to the list\n"
		"\t                    specified through the LSB_MODULES environment setting.\n"
		"\t                    known modules: %s\n"
		...
		"\t                    help when using lsbcc in conjunction with libtool.  See the\n"
