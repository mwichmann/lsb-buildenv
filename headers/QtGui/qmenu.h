...
extern "C" {
    ...
    extern Class _ZN5QMenuC2EP7QWidget(void);
    extern Class _ZN5QMenuC1EP7QWidget(void);
    extern Class _ZN5QMenuC2ERK7QStringP7QWidget(void);
    extern Class _ZN5QMenuC1ERK7QStringP7QWidget(void);
    extern Class _ZN5QMenuD2Ev(void);
    extern Class _ZN5QMenuD1Ev(void);
    extern Class _ZN5QMenuD0Ev(void);
    extern Class _ZN5QMenu9addActionERK7QString(void);
    extern Class _ZN5QMenu9addActionERK5QIconRK7QString(void);
    extern Class
	_ZN5QMenu9addActionERK7QStringPK7QObjectPKcRK12QKeySequence(void);
    extern Class
	_ZN5QMenu9addActionERK5QIconRK7QStringPK7QObjectPKcRK12QKeySequence
	(void);
    extern Class _ZN5QMenu7addMenuEPS_(void);
    extern Class _ZN5QMenu7addMenuERK7QString(void);
    extern Class _ZN5QMenu7addMenuERK5QIconRK7QString(void);
    extern Class _ZN5QMenu12addSeparatorEv(void);
    extern Class _ZN5QMenu10insertMenuEP7QActionPS_(void);
    extern Class _ZN5QMenu15insertSeparatorEP7QAction(void);
    ...
    extern Class _ZNK5QMenu13defaultActionEv(void);
    extern void _ZN5QMenu15setActiveActionEP7QAction(void);
    extern Class _ZNK5QMenu12activeActionEv(void);
    extern void _ZN5QMenu5popupERK6QPointP7QAction(void);
    extern Class _ZN5QMenu4execEv(void);
    extern Class _ZN5QMenu4execERK6QPointP7QAction(void);
    extern Class _ZN5QMenu4execE5QListIP7QActionERK6QPointS2_(void);
    extern Class _ZNK5QMenu8sizeHintEv(void);
    extern Class _ZNK5QMenu14actionGeometryEP7QAction(void);
    extern Class _ZNK5QMenu8actionAtERK6QPoint(void);
    extern Class _ZNK5QMenu10menuActionEv(void);
    extern Class _ZNK5QMenu5titleEv(void);
    extern void _ZN5QMenu8setTitleERK7QString(void);
    extern Class _ZNK5QMenu4iconEv(void);
