...
extern "C" {
    ...
    extern Class _ZN12QPainterPathC2Ev(void);
    extern Class _ZN12QPainterPathC1Ev(void);
    extern Class _ZN12QPainterPathC2ERK7QPointF(void);
    extern Class _ZN12QPainterPathC1ERK7QPointF(void);
    extern Class _ZN12QPainterPathC2ERKS_(void);
    extern Class _ZN12QPainterPathC1ERKS_(void);
    extern Class _ZN12QPainterPathaSERKS_(void);
    extern Class _ZN12QPainterPathD2Ev(void);
    extern Class _ZN12QPainterPathD1Ev(void);
    ...
    extern Class _ZNK12QPainterPath15currentPositionEv(void);
    ...
    extern void
	_ZN12QPainterPath7addTextERK7QPointFRK5QFontRK7QString(void);
    ...
    extern Class _ZNK12QPainterPath12boundingRectEv(void);
    extern Class _ZNK12QPainterPath16controlPointRectEv(void);
    ...
    extern Class _ZNK12QPainterPath10toReversedEv(void);
    extern _ZNK12QPainterPath17toSubpathPolygonsERK7QMatrix(void);
    extern _ZNK12QPainterPath14toFillPolygonsERK7QMatrix(void);
    extern Class _ZNK12QPainterPath13toFillPolygonERK7QMatrix(void);
    extern bool _ZNK12QPainterPatheqERKS_(void);
    extern bool _ZNK12QPainterPathneERKS_(void);
    extern Class _ZlsR11QDataStreamRK12QPainterPath(void);
    extern Class _ZrsR11QDataStreamR12QPainterPath(void);
    extern Class _ZN19QPainterPathStrokerC2Ev(void);
    extern Class _ZN19QPainterPathStrokerC1Ev(void);
    extern Class _ZN19QPainterPathStrokerD2Ev(void);
    extern Class _ZN19QPainterPathStrokerD1Ev(void);
    extern void _ZN19QPainterPathStroker8setWidthEd(void);
    extern qreal _ZNK19QPainterPathStroker5widthEv(void);
    extern void
	_ZN19QPainterPathStroker11setCapStyleEN2Qt11PenCapStyleE(void);
    extern enum N2Qt11PenCapStyleE
	_ZNK19QPainterPathStroker8capStyleEv(void);
    extern void
	_ZN19QPainterPathStroker12setJoinStyleEN2Qt12PenJoinStyleE(void);
    extern enum N2Qt12PenJoinStyleE
	_ZNK19QPainterPathStroker9joinStyleEv(void);
    ...
    extern void
	_ZN19QPainterPathStroker14setDashPatternEN2Qt8PenStyleE(void);
    extern void
	_ZN19QPainterPathStroker14setDashPatternERK7QVectorIdE(void);
    extern _ZNK19QPainterPathStroker11dashPatternEv(void);
    extern Class
	_ZNK19QPainterPathStroker12createStrokeERK12QPainterPath(void);
#ifdef __cplusplus
}
#endif
#endif
