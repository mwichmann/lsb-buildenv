...
extern "C" {
    ...
    extern Class _ZN9QTreeViewC2EP7QWidget(void);
    extern Class _ZN9QTreeViewC1EP7QWidget(void);
    extern Class _ZN9QTreeViewD2Ev(void);
    extern Class _ZN9QTreeViewD1Ev(void);
    extern Class _ZN9QTreeViewD0Ev(void);
    ...
    extern void
	_ZN9QTreeView17setSelectionModelEP19QItemSelectionModel(void);
    ...
    extern Class _ZNK9QTreeView10visualRectERK11QModelIndex(void);
    extern void
	_ZN9QTreeView8scrollToERK11QModelIndexN17QAbstractItemView10ScrollHintE
	(void);
    extern Class _ZNK9QTreeView7indexAtERK6QPoint(void);
    extern Class _ZNK9QTreeView10indexAboveERK11QModelIndex(void);
    extern Class _ZNK9QTreeView10indexBelowERK11QModelIndex(void);
    ...
    extern Class _ZN9QTreeViewC2ER16QTreeViewPrivateP7QWidget(void);
    extern Class _ZN9QTreeViewC1ER16QTreeViewPrivateP7QWidget(void);
    extern void _ZN9QTreeView16scrollContentsByEii(void);
    extern void _ZN9QTreeView12rowsInsertedERK11QModelIndexii(void);
    extern void
	_ZN9QTreeView20rowsAboutToBeRemovedERK11QModelIndexii(void);
    extern Class
	_ZN9QTreeView10moveCursorEN17QAbstractItemView12CursorActionE6QFlagsIN2Qt16KeyboardModifierEE
	(void);
    extern int _ZNK9QTreeView16horizontalOffsetEv(void);
    extern int _ZNK9QTreeView14verticalOffsetEv(void);
    extern void
	_ZN9QTreeView12setSelectionERK5QRect6QFlagsIN19QItemSelectionModel13SelectionFlagEE
	(void);
    extern Class
	_ZNK9QTreeView24visualRegionForSelectionERK14QItemSelection(void);
