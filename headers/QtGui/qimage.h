...
extern "C" {
    ...
    extern Class _ZN6QImageC2Ev(void);
    extern Class _ZN6QImageC1Ev(void);
    extern Class _ZN6QImageC2ERK5QSizeNS_6FormatE(void);
    extern Class _ZN6QImageC1ERK5QSizeNS_6FormatE(void);
    extern Class _ZN6QImageC2EiiNS_6FormatE(void);
    extern Class _ZN6QImageC1EiiNS_6FormatE(void);
    extern Class _ZN6QImageC2EPhiiNS_6FormatE(void);
    extern Class _ZN6QImageC1EPhiiNS_6FormatE(void);
    extern Class _ZN6QImageC2EPKPKc(void);
    extern Class _ZN6QImageC1EPKPKc(void);
    extern Class _ZN6QImageC2ERK7QStringPKc(void);
    extern Class _ZN6QImageC1ERK7QStringPKc(void);
    extern Class _ZN6QImageC2EPKcS1_(void);
    extern Class _ZN6QImageC1EPKcS1_(void);
    extern Class _ZN6QImageC2ERKS_(void);
    extern Class _ZN6QImageC1ERKS_(void);
    extern Class _ZN6QImageD2Ev(void);
    extern Class _ZN6QImageD1Ev(void);
    extern Class _ZN6QImageD0Ev(void);
    extern Class _ZN6QImageaSERKS_(void);
    ...
    extern Class _ZNK6QImagecv8QVariantEv(void);
    extern void _ZN6QImage6detachEv(void);
    extern bool _ZNK6QImage10isDetachedEv(void);
    extern Class _ZNK6QImage4copyERK5QRect(void);
	...
	(void);
    extern Class
	_ZNK6QImage15convertToFormatENS_6FormatERK7QVectorIjE6QFlagsIN2Qt19ImageConversionFlagEE
	(void);
    extern int _ZNK6QImage5widthEv(void);
    extern int _ZNK6QImage6heightEv(void);
    extern Class _ZNK6QImage4sizeEv(void);
    extern Class _ZNK6QImage4rectEv(void);
    ...
    extern Class _ZNK6QImage12alphaChannelEv(void);
    extern Class
	_ZNK6QImage15createAlphaMaskE6QFlagsIN2Qt19ImageConversionFlagEE
	(void);
    extern Class _ZNK6QImage19createHeuristicMaskEb(void);
    extern Class
	_ZNK6QImage6scaledERK5QSizeN2Qt15AspectRatioModeENS3_18TransformationModeE
	(void);
    extern Class
	_ZNK6QImage13scaledToWidthEiN2Qt18TransformationModeE(void);
    extern Class
	_ZNK6QImage14scaledToHeightEiN2Qt18TransformationModeE(void);
    extern Class
	_ZNK6QImage11transformedERK7QMatrixN2Qt18TransformationModeE(void);
    extern _ZN6QImage10trueMatrixERK7QMatrixii(void);
    extern Class _ZNK6QImage8mirroredEbb(void);
    extern Class _ZNK6QImage10rgbSwappedEv(void);
    ...
    extern Class _ZN6QImage8fromDataEPKhiPKc(void);
    ...
    extern Class _ZNK6QImage6offsetEv(void);
    extern void _ZN6QImage9setOffsetERK6QPoint(void);
    extern Class _ZNK6QImage8textKeysEv(void);
    extern Class _ZNK6QImage4textERK7QString(void);
    extern void _ZN6QImage7setTextERK7QStringS2_(void);
    extern Class _ZNK6QImage4textEPKcS1_(void);
    extern _ZNK6QImage8textListEv(void);
    extern Class _ZNK6QImage13textLanguagesEv(void);
    extern Class _ZNK6QImage4textERK17QImageTextKeyLang(void);
    extern void _ZN6QImage7setTextEPKcS1_RK7QString(void);
    extern Class _ZN6QImageC2EiiiiNS_6EndianE(void);
    extern Class _ZN6QImageC1EiiiiNS_6EndianE(void);
    extern Class _ZN6QImageC2ERK5QSizeiiNS_6EndianE(void);
    extern Class _ZN6QImageC1ERK5QSizeiiNS_6EndianE(void);
    extern Class _ZN6QImageC2EPhiiiPKjiNS_6EndianE(void);
    extern Class _ZN6QImageC1EPhiiiPKjiNS_6EndianE(void);
    extern Class
	_ZNK6QImage12convertDepthEi6QFlagsIN2Qt19ImageConversionFlagEE
	(void);
    extern Class
	_ZNK6QImage23convertDepthWithPaletteEiPji6QFlagsIN2Qt19ImageConversionFlagEE
	(void);
    extern Class _ZNK6QImage15convertBitOrderENS_6EndianE(void);
    ...
    extern int
	_ZNK6QImage6metricEN12QPaintDevice17PaintDeviceMetricE(void);
    extern Class _ZlsR11QDataStreamRK6QImage(void);
    extern Class _ZrsR11QDataStreamR6QImage(void);
    extern void
	_Z6bitBltP6QImageiiPKS_iiii6QFlagsIN2Qt19ImageConversionFlagEE
	(void);
#ifdef __cplusplus
}
#endif
