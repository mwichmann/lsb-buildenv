...
extern Boolean XtCvtStringToGravity (Display *, XrmValuePtr, Cardinal *,
				     XrmValuePtr, XrmValuePtr, XtPointer *);
extern Boolean XtCvtStringToInitialState (Display *, XrmValuePtr, Cardinal *,
					  XrmValuePtr, XrmValuePtr,
					  XtPointer *);
...
extern Boolean XtCvtStringToPixel (Display *, XrmValuePtr, Cardinal *,
				   XrmValuePtr, XrmValuePtr, XtPointer *);
extern Boolean XtCvtStringToRestartStyle (Display *, XrmValuePtr, Cardinal *,
					  XrmValuePtr, XrmValuePtr,
					  XtPointer *);
...
extern Boolean XtCvtStringToTranslationTable (Display *, XrmValuePtr,
					      Cardinal *, XrmValuePtr,
					      XrmValuePtr, XtPointer *);
extern Boolean XtCvtStringToUnsignedChar (Display *, XrmValuePtr, Cardinal *,
					  XrmValuePtr, XrmValuePtr,
					  XtPointer *);
...
extern void XtGrabButton (Widget, int, Modifiers, int, unsigned int, int, int,
			  Window, Cursor);
extern void XtGrabKey (Widget, unsigned int, Modifiers, int, int, int);
extern int XtGrabKeyboard (Widget, int, int, int, Time);
extern int XtGrabPointer (Widget, int, unsigned int, int, int, Window, Cursor,
			  Time);
...
extern void XtRegisterGrabAction (XtActionProc, int, unsigned int, int, int);
...
extern Widget XtVaOpenApplication (XtAppContext *, char *, XrmOptionDescList,
				   Cardinal, int *, String *, String *,
				   WidgetClass, ...);
