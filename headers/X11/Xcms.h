...
int XcmsCIELabClipL(XcmsCCC, XcmsColor *, unsigned int, unsigned int,
...
int XcmsCIELabWhiteShiftColors(XcmsCCC, XcmsColor *, XcmsColor *,
			       ...
			       int *);
int XcmsCIELuvClipL(XcmsCCC, XcmsColor *, unsigned int, unsigned int,
...
int XcmsTekHVCClipC(XcmsCCC, XcmsColor *, unsigned int, unsigned int,

		    int *);
int XcmsTekHVCClipV(XcmsCCC, XcmsColor *, unsigned int, unsigned int,
