...
int XAllocColorCells(Display *, Colormap, int, unsigned long *,
...
Cursor XCreateGlyphCursor(Display *, Font, Font, unsigned int,
...
int XQueryTextExtents(Display *, XID, char *, int, int *, int *, int *,
		      XCharStruct *);
int XQueryTextExtents16(Display *, XID, XChar2b *, int, int *, int *,
			int *, XCharStruct *);
...
int XTranslateCoordinates(Display *, Window, Window, int, int, int *,
			  int *, Window *);
...
int XWriteBitmapFile(Display *, char *, Pixmap, unsigned int, unsigned int,
		     int, int);
void XmbDrawImageString(Display *, Drawable, XFontSet, GC, int, int,
			char *, int);
void XmbDrawString(Display *, Drawable, XFontSet, GC, int, int, char *,
...
int XmbTextPerCharExtents(XFontSet, char *, int, XRectangle *,
