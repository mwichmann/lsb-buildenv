...
class QSqlDriverPlugin :  QObject,  QSqlDriverFactoryInterface
{
private:
public:
};
...
extern  _ZN26QSqlDriverFactoryInterfaceD0Ev(void);
extern  _ZN26QSqlDriverFactoryInterfaceD1Ev(void);
extern struct QMetaObject _ZN16QSqlDriverPlugin16staticMetaObjectE ;
extern struct QMetaObject _ZNK16QSqlDriverPlugin10metaObjectEv(void);
extern void _ZN16QSqlDriverPlugin11qt_metacastEPKc(void);
