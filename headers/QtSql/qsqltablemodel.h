...
extern "C" {
    ...
    extern int
	_ZN14QSqlTableModel11qt_metacallEN11QMetaObject4CallEiPPv(void);
    extern Class _ZN14QSqlTableModelC2EP7QObject12QSqlDatabase(void);
    extern Class _ZN14QSqlTableModelC1EP7QObject12QSqlDatabase(void);
    extern Class _ZN14QSqlTableModelD2Ev(void);
    extern Class _ZN14QSqlTableModelD1Ev(void);
    extern Class _ZN14QSqlTableModelD0Ev(void);
    extern bool _ZN14QSqlTableModel6selectEv(void);
    extern void _ZN14QSqlTableModel8setTableERK7QString(void);
    extern Class _ZNK14QSqlTableModel9tableNameEv(void);
    extern N2Qt9ItemFlagsE
	_ZNK14QSqlTableModel5flagsERK11QModelIndex(void);
    extern Class _ZNK14QSqlTableModel4dataERK11QModelIndexi(void);
    extern bool
	_ZN14QSqlTableModel7setDataERK11QModelIndexRK8QVarianti(void);
    extern Class
	_ZNK14QSqlTableModel10headerDataEiN2Qt11OrientationEi(void);
    extern bool _ZNK14QSqlTableModel7isDirtyERK11QModelIndex(void);
    extern void _ZN14QSqlTableModel5clearEv(void);
    extern void
	_ZN14QSqlTableModel15setEditStrategyENS_12EditStrategyE(void);
    extern enum N14QSqlTableModel12EditStrategyE
	_ZNK14QSqlTableModel12editStrategyEv(void);
    extern Class _ZNK14QSqlTableModel10primaryKeyEv(void);
    extern Class _ZNK14QSqlTableModel8databaseEv(void);
    ...
    extern Class _ZNK14QSqlTableModel6filterEv(void);
    ...
    extern Class
	_ZN14QSqlTableModelC2ER21QSqlTableModelPrivateP7QObject12QSqlDatabase
	(void);
    extern Class
	_ZN14QSqlTableModelC1ER21QSqlTableModelPrivateP7QObject12QSqlDatabase
	(void);
    extern bool
	_ZN14QSqlTableModel16updateRowInTableEiRK10QSqlRecord(void);
    extern bool
	_ZN14QSqlTableModel18insertRowIntoTableERK10QSqlRecord(void);
    extern bool _ZN14QSqlTableModel18deleteRowFromTableEi(void);
    extern Class _ZNK14QSqlTableModel13orderByClauseEv(void);
    extern Class _ZNK14QSqlTableModel15selectStatementEv(void);
    ...
    extern Class _ZNK14QSqlTableModel12indexInQueryERK11QModelIndex(void);
#ifdef __cplusplus
}
#endif
#endif
