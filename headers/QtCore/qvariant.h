...
extern QDataStream _ZrsR11QDataStreamR8QVariant(QDataStream &, QVariant &);
extern QDataStream _ZlsR11QDataStreamRK8QVariant(QDataStream &, const QVariant &);
extern QDataStream _ZrsR11QDataStreamRN8QVariant4TypeE(QDataStream &, enum QVariant::Type &);
extern QDataStream _ZlsR11QDataStreamN8QVariant4TypeE(QDataStream &, enum QVariant::Type);
extern QDebug _Zls6QDebugRK8QVariant(_Z6QDebug, const QVariant &);
extern QDebug _Zls6QDebugN8QVariant4TypeE(_Z6QDebug, enum QVariant::Type);
// *INDENT-ON*
#endif
