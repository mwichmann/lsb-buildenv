...
extern "C" {
    ...
    extern Class _ZN5QCharC2Ec(void);
    extern Class _ZN5QCharC1Ec(void);
    extern Class _ZN5QCharC2Eh(void);
    extern Class _ZN5QCharC1Eh(void);
    extern int _ZNK5QChar10digitValueEv(void);
    extern Class _ZNK5QChar7toLowerEv(void);
    extern Class _ZNK5QChar7toUpperEv(void);
    ...
    extern Class _ZNK5QChar12mirroredCharEv(void);
    extern _ZNK5QChar13decompositionEv(void);
    extern enum N5QChar13DecompositionE
	_ZNK5QChar16decompositionTagEv(void);
    extern unsigned char _ZNK5QChar14combiningClassEv(void);
    extern enum N5QChar14UnicodeVersionE
	_ZNK5QChar14unicodeVersionEv(void);
    extern char _ZNK5QChar7toAsciiEv(void);
    extern Class _ZN5QChar9fromAsciiEc(void);
