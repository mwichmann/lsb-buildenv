...
extern "C" {
    ...
    typedef Unknown Type:".Class." QObjectList;
    ...
    extern Class _ZN7QObjectC2EPS_(void);
    extern Class _ZN7QObjectC1EPS_(void);
    extern Class _ZN7QObjectD2Ev(void);
    extern Class _ZN7QObjectD1Ev(void);
    extern Class _ZN7QObjectD0Ev(void);
    extern bool _ZN7QObject5eventEP6QEvent(void);
    extern bool _ZN7QObject11eventFilterEPS_P6QEvent(void);
    extern Class _ZNK7QObject10objectNameEv(void);
    ...
    extern Class _ZNK7QObject5childEPKcS1_b(void);
    extern QObjectList _ZNK7QObject9queryListEPKcS1_bb(void);
    ...
    extern bool
	_ZN7QObject7connectEPKS_PKcS1_S3_N2Qt14ConnectionTypeE(void);
    ...
    extern Class _ZNK7QObject6senderEv(void);
    ...
    extern Class _ZN7QObjectC2EPS_PKc(void);
    extern Class _ZN7QObjectC1EPS_PKc(void);
    extern Class _ZN7QObjectC2ER14QObjectPrivatePS_(void);
    extern Class _ZN7QObjectC1ER14QObjectPrivatePS_(void);
    extern struct QMetaObject _ZN7QObject18staticQtMetaObjectE;
    extern Class _ZN15QObjectUserDataD2Ev(void);
    extern Class _ZN15QObjectUserDataD1Ev(void);
    extern Class _ZN15QObjectUserDataD0Ev(void);
    extern void
	_Z23qt_qFindChildren_helperPK7QObjectRK7QStringPK7QRegExpRK11QMetaObjectP5QListIPvE
	(void);
    extern Class
	_Z20qt_qFindChild_helperPK7QObjectRK7QStringRK11QMetaObject(void);
