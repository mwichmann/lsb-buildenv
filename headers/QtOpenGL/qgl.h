...
extern "C" {
    ...
    typedef Unknown Type:".." N3QGL13FormatOptionsE;

    enum N3QGL12FormatOptionE {
	DoubleBuffer,
	DepthBuffer,
	Rgba,
	AlphaChannel,
    ...
    extern Class _ZN9QGLFormatC2Ev(void);
    extern Class _ZN9QGLFormatC1Ev(void);
    extern Class _ZN9QGLFormatC2E6QFlagsIN3QGL12FormatOptionEEi(void);
    extern Class _ZN9QGLFormatC1E6QFlagsIN3QGL12FormatOptionEEi(void);
    extern Class _ZN9QGLFormatC2ERKS_(void);
    extern Class _ZN9QGLFormatC1ERKS_(void);
    extern Class _ZN9QGLFormataSERKS_(void);
    extern Class _ZN9QGLFormatD2Ev(void);
    extern Class _ZN9QGLFormatD1Ev(void);
    ...
    extern void
	_ZN9QGLFormat9setOptionE6QFlagsIN3QGL12FormatOptionEE(void);
    extern bool
	_ZNK9QGLFormat10testOptionE6QFlagsIN3QGL12FormatOptionEE(void);
    extern Class _ZN9QGLFormat13defaultFormatEv(void);
    extern void _ZN9QGLFormat16setDefaultFormatERKS_(void);
    extern Class _ZN9QGLFormat20defaultOverlayFormatEv(void);
    ...
    extern Class _ZN10QGLContextC2ERK9QGLFormatP12QPaintDevice(void);
    extern Class _ZN10QGLContextC1ERK9QGLFormatP12QPaintDevice(void);
    extern Class _ZN10QGLContextC2ERK9QGLFormat(void);
    extern Class _ZN10QGLContextC1ERK9QGLFormat(void);
    extern Class _ZN10QGLContextD2Ev(void);
    extern Class _ZN10QGLContextD1Ev(void);
    extern Class _ZN10QGLContextD0Ev(void);
    ...
    extern Class _ZNK10QGLContext6formatEv(void);
    extern Class _ZNK10QGLContext15requestedFormatEv(void);
    ...
    extern Class _ZNK10QGLContext6deviceEv(void);
    extern Class _ZNK10QGLContext23overlayTransparentColorEv(void);
    extern Class _ZN10QGLContext14currentContextEv(void);
    ...
    extern Class *_ZN10QGLContext10currentCtxE;
    ...
    extern Class
	_ZN9QGLWidgetC2EP7QWidgetPKS_6QFlagsIN2Qt10WindowTypeEE(void);
    extern Class
	_ZN9QGLWidgetC1EP7QWidgetPKS_6QFlagsIN2Qt10WindowTypeEE(void);
    extern Class
	_ZN9QGLWidgetC2EP10QGLContextP7QWidgetPKS_6QFlagsIN2Qt10WindowTypeEE
	(void);
    extern Class
	_ZN9QGLWidgetC1EP10QGLContextP7QWidgetPKS_6QFlagsIN2Qt10WindowTypeEE
	(void);
    extern Class
	...
	(void);
    extern Class
	_ZN9QGLWidgetC2EP7QWidgetPKcPKS_6QFlagsIN2Qt10WindowTypeEE(void);
    extern Class
	_ZN9QGLWidgetC1EP7QWidgetPKcPKS_6QFlagsIN2Qt10WindowTypeEE(void);
    extern Class
	_ZN9QGLWidgetC2EP10QGLContextP7QWidgetPKcPKS_6QFlagsIN2Qt10WindowTypeEE
	(void);
    extern Class
	_ZN9QGLWidgetC1EP10QGLContextP7QWidgetPKcPKS_6QFlagsIN2Qt10WindowTypeEE
	(void);
    extern Class
	_ZN9QGLWidgetC2ERK9QGLFormatP7QWidgetPKcPKS_6QFlagsIN2Qt10WindowTypeEE
	(void);
    extern Class
	_ZN9QGLWidgetC1ERK9QGLFormatP7QWidgetPKcPKS_6QFlagsIN2Qt10WindowTypeEE
	(void);
    extern Class _ZN9QGLWidgetD2Ev(void);
    extern Class _ZN9QGLWidgetD1Ev(void);
    extern Class _ZN9QGLWidgetD0Ev(void);
    ...
    extern Class _ZNK9QGLWidget6formatEv(void);
    extern void _ZN9QGLWidget9setFormatERK9QGLFormat(void);
    extern Class _ZNK9QGLWidget7contextEv(void);
    extern void _ZN9QGLWidget10setContextEP10QGLContextPKS0_b(void);
    extern Class _ZN9QGLWidget12renderPixmapEiib(void);
    extern Class _ZN9QGLWidget15grabFrameBufferEb(void);
    extern void _ZN9QGLWidget18makeOverlayCurrentEv(void);
    extern Class _ZNK9QGLWidget14overlayContextEv(void);
    extern Class _ZN9QGLWidget17convertToGLFormatERK6QImage(void);
    extern void _ZN9QGLWidget16setMouseTrackingEb(void);
    extern Class _ZNK9QGLWidget8colormapEv(void);
    ...
    extern Class _ZNK9QGLWidget11paintEngineEv(void);
