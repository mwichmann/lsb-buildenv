...
/* Function prototypes */
    ...
    extern void _gtk_accel_group_attach(GtkAccelGroup * accel_group,
					GObject *);
    extern void _gtk_accel_group_detach(GtkAccelGroup * accel_group,
					GObject *);
    extern GSList *_gtk_accel_group_get_accelerables(GtkAccelGroup *
						     accel_group);
    extern void _gtk_accel_group_reconnect(GtkAccelGroup * accel_group,
					   GQuark);
    extern gchar
	*_gtk_accel_label_class_get_accelerator_label(GtkAccelLabelClass *
						      klass, guint,
						      GdkModifierType);
    extern void _gtk_action_add_to_proxy_list(GtkAction * action,
					      GtkWidget *);
    extern void _gtk_action_emit_activate(GtkAction * action);
    extern void _gtk_action_group_emit_connect_proxy(GtkActionGroup *
						     action_group,
						     GtkAction *,
						     GtkWidget *);
    extern void _gtk_action_group_emit_disconnect_proxy(GtkActionGroup *
							action_group,
							GtkAction *,
							GtkWidget *);
    extern void _gtk_action_group_emit_post_activate(GtkActionGroup *
						     action_group,
						     GtkAction *);
    extern void _gtk_action_group_emit_pre_activate(GtkActionGroup *
						    action_group,
						    GtkAction *);
    extern void _gtk_action_remove_from_proxy_list(GtkAction * action,
						   GtkWidget *);
    extern void _gtk_action_sync_menu_visible(GtkAction * action,
					      GtkWidget *, gboolean);
    extern void _gtk_bin_set_child(GtkBin * bin, GtkWidget *);
    extern gboolean _gtk_cell_area_box_group_visible(GtkCellAreaBox * box,
						     gint);
    extern void _gtk_cell_area_set_cell_data_func_with_proxy(GtkCellArea *
							     area,
							     GtkCellRenderer
							     *, GFunc,
							     gpointer,
							     GDestroyNotify,
							     gpointer);
    extern void _gtk_cell_layout_buildable_add_child(GtkBuildable *
						     buildable,
						     GtkBuilder *,
						     GObject *,
						     const char *);
    extern gboolean _gtk_cell_layout_buildable_custom_tag_end(GtkBuildable
							      * buildable,
							      GtkBuilder *,
							      GObject *,
							      const char *,
							      void **);
    extern gboolean
	_gtk_cell_layout_buildable_custom_tag_start(GtkBuildable *
						    buildable,
						    GtkBuilder *,
						    GObject *,
						    const char *,
						    GMarkupParser *,
						    void **);
    extern void _gtk_cell_renderer_calc_offset(GtkCellRenderer * cell,
					       const struct
					       _cairo_rectangle_int *,
					       GtkTextDirection, gint,
					       gint, gint *, gint *);
    extern void
	_gtk_cell_renderer_class_set_accessible_type(GtkCellRendererClass *
						     renderer_class,
						     GType);
    extern GType _gtk_cell_renderer_get_accessible_type(GtkCellRenderer *
							renderer);
    extern void _gtk_check_button_get_props(GtkCheckButton * check_button,
					    gint *, gint *);
    extern void _gtk_check_menu_item_set_active(GtkCheckMenuItem *
						check_menu_item, gboolean);
    extern void _gtk_clipboard_handle_event(GdkEventOwnerChange * event);
    extern void _gtk_clipboard_store_all(void);
    extern void _gtk_drag_dest_handle_event(GtkWidget * toplevel,
					    GdkEvent *);
    extern void _gtk_drag_source_handle_event(GtkWidget * widget,
					      GdkEvent *);
    extern void _gtk_icon_factory_ensure_default_icons(void);
    extern GList *_gtk_icon_factory_list_ids(void);
    extern void _gtk_icon_set_invalidate_caches(void);
    extern void _gtk_icon_theme_check_reload(GdkDisplay * display);
    extern void _gtk_icon_theme_ensure_builtin_cache(void);
    extern gint _gtk_label_get_cursor_position(GtkLabel * label);
    extern gint _gtk_label_get_selection_bound(GtkLabel * label);
    extern void _gtk_label_mnemonics_visible_apply_recursively(GtkWidget *
							       widget,
							       gboolean);
    extern void _gtk_menu_bar_cycle_focus(GtkMenuBar * menubar,
					  GtkDirectionType);
    extern void _gtk_misc_get_padding_and_border(GtkMisc * misc,
						 GtkBorder *);
    extern gboolean _gtk_range_get_has_origin(GtkRange * range);
    extern gint _gtk_range_get_stop_positions(GtkRange * range, gint * *);
    extern gdouble _gtk_range_get_wheel_delta(GtkRange * range,
					      GdkEventScroll *);
    extern void _gtk_range_set_has_origin(GtkRange * range, gboolean);
    extern void _gtk_range_set_steppers(GtkRange * range, gboolean,
					gboolean, gboolean, gboolean);
    extern void _gtk_range_set_stop_values(GtkRange * range, gdouble *,
					   gint);
    extern void _gtk_recent_manager_sync(void);
    extern gint
	_gtk_scrolled_window_get_scrollbar_spacing(GtkScrolledWindow *
						   scrolled_window);
    extern void _gtk_spin_button_get_panels(GtkSpinButton * spin_button,
					    GdkWindow * *, GdkWindow * *);
    extern AtkAttributeSet
	*_gtk_style_context_get_attributes(AtkAttributeSet * attributes,
					   GtkStyleContext *,
					   GtkStateFlags);
    extern GtkTextBTree *_gtk_text_buffer_get_btree(GtkTextBuffer *
						    buffer);
    extern const struct _PangoLogAttr
	*_gtk_text_buffer_get_line_log_attrs(GtkTextBuffer * buffer,
					     const struct _GtkTextIter *,
					     gint *);
    extern void _gtk_text_buffer_get_text_after(GtkTextBuffer * buffer,
						AtkTextBoundary,
						GtkTextIter *,
						GtkTextIter *,
						GtkTextIter *);
    extern void _gtk_text_buffer_get_text_at(GtkTextBuffer * buffer,
					     AtkTextBoundary,
					     GtkTextIter *, GtkTextIter *,
					     GtkTextIter *);
    extern void _gtk_text_buffer_get_text_before(GtkTextBuffer * buffer,
						 AtkTextBoundary,
						 GtkTextIter *,
						 GtkTextIter *,
						 GtkTextIter *);
    extern void _gtk_text_buffer_notify_will_remove_tag(GtkTextBuffer *
							buffer,
							GtkTextTag *);
    extern void _gtk_text_buffer_spew(GtkTextBuffer * buffer);
    extern void _gtk_text_tag_table_add_buffer(GtkTextTagTable * table,
					       gpointer);
    extern void _gtk_text_tag_table_remove_buffer(GtkTextTagTable * table,
						  gpointer);
    extern void _gtk_toggle_action_set_active(GtkToggleAction *
					      toggle_action, gboolean);
    extern void _gtk_toggle_button_set_active(GtkToggleButton *
					      toggle_button, gboolean);
    extern GtkWidget *_gtk_tool_button_get_button(GtkToolButton * button);
    extern gboolean _gtk_tool_item_create_menu_proxy(GtkToolItem *
						     tool_item);
    extern gchar *_gtk_toolbar_elide_underscores(const char *original);
    extern gint _gtk_toolbar_get_default_space_size(void);
    extern void _gtk_toolbar_paint_space_line(GtkWidget * widget,
					      GtkToolbar *, cairo_t *);
    extern void _gtk_tooltip_focus_in(GtkWidget * widget);
    extern void _gtk_tooltip_focus_out(GtkWidget * widget);
    extern void _gtk_tooltip_handle_event(GdkEvent * event);
    extern void _gtk_tooltip_hide(GtkWidget * widget);
    extern void _gtk_tooltip_toggle_keyboard_mode(GtkWidget * widget);
    extern GtkWidget *_gtk_widget_find_at_coords(GdkWindow * window, gint,
						 gint, gint *, gint *);
	...
	*gtk_about_dialog_get_translator_credits(GtkAboutDialog * about);
    ...
    extern gboolean gtk_accel_group_activate(GtkAccelGroup * accel_group,
					     GQuark, GObject *, guint,
					     GdkModifierType);
    extern void gtk_accel_group_connect(GtkAccelGroup * accel_group, guint,
    ...
    extern gboolean gtk_accel_groups_activate(GObject * object, guint,
					      GdkModifierType);
    ...
    extern void gtk_accel_map_add_entry(const char *accel_path, guint,
					GdkModifierType);
    extern void gtk_accel_map_add_filter(const char *filter_pattern);
    extern gboolean gtk_accel_map_change_entry(const char *accel_path,
					       guint, GdkModifierType,
					       gboolean);
    ...
    extern void gtk_accelerator_set_default_mod_mask(GdkModifierType
						     default_mod_mask);
    extern gboolean gtk_accelerator_valid(guint keyval, GdkModifierType);
	...
	*gtk_app_chooser_widget_get_default_text(GtkAppChooserWidget *
    ...
    extern void gtk_binding_entry_remove(GtkBindingSet * binding_set,
					 guint, GdkModifierType);
    extern void gtk_binding_entry_skip(GtkBindingSet * binding_set, guint,
				       GdkModifierType);
	...
	**gtk_container_class_list_child_properties(GObjectClass * cclass,
    ...
    extern void gtk_drag_dest_set(GtkWidget * widget, GtkDestDefaults,
				  const struct _GtkTargetEntry *, gint,
				  GdkDragAction);
    extern void gtk_drag_dest_set_proxy(GtkWidget * widget, GdkWindow *,
    ...
    extern GtkTargetList *gtk_drag_source_get_target_list(GtkWidget *
							  widget);
    extern void gtk_drag_source_set(GtkWidget * widget, GdkModifierType,
				    const struct _GtkTargetEntry *, gint,
				    GdkDragAction);
	...
	*gtk_scrolled_window_get_vadjustment(GtkScrolledWindow *
    ...
    extern void gtk_selection_add_target(GtkWidget * widget, GdkAtom,
					 GdkAtom, guint);
    extern void gtk_selection_add_targets(GtkWidget * widget, GdkAtom,
					  const GtkTargetEntry *, guint);
    extern void gtk_selection_clear_targets(GtkWidget * widget, GdkAtom);
    extern gboolean gtk_selection_convert(GtkWidget * widget, GdkAtom,
					  GdkAtom, guint32);
	...
	*gtk_selection_data_get_data_with_length(const struct
    ...
    extern gboolean gtk_selection_owner_set(GtkWidget * widget, GdkAtom,
					    guint32);
	...
	*gtk_style_provider_get_style(GtkStyleProvider * provider,
    ...
    extern void gtk_target_list_add(GtkTargetList * list, GdkAtom, guint,
				    guint);
	...
	*gtk_window_group_get_current_device_grab(GtkWindowGroup *
    ...
    extern gboolean gtk_window_mnemonic_activate(GtkWindow * window, guint,
						 GdkModifierType);
