...
/* event masks*/
  ...
  extern int chgat (int, attr_t, short, void *);
  ...
  extern int mvchgat (int, int, int, attr_t, short, void *);
  ...
  extern int mvwchgat (WINDOW *, int, int, int, attr_t, short, void *);
  ...
  extern int wchgat (WINDOW *, int, attr_t, short, void *);
