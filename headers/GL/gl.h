...
extern void glMap2f (GLenum, GLfloat, GLfloat, GLint, GLint, GLfloat, GLfloat,
		     GLint, GLint, GLfloat *);
...
extern void glGetSeparableFilter (GLenum, GLenum, GLenum, GLvoid *, GLvoid *,
				  GLvoid *);
...
extern void glCopyConvolutionFilter2D (GLenum, GLenum, GLint, GLint, GLsizei,
				       GLsizei);
...
extern void glColorSubTable (GLenum, GLsizei, GLsizei, GLenum, GLenum,
			     GLvoid *);
extern void glColorTable (GLenum, GLenum, GLsizei, GLenum, GLenum, GLvoid *);
