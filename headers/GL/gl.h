...
/* Function prototypes */
    ...
    extern GLboolean glAreTexturesResident(GLsizei, const GLuint *,
					   GLboolean *);
    ...
    extern void glIndexPointer(GLenum, GLsizei, const GLvoid *);
    ...
    extern void glInterleavedArrays(GLenum, GLsizei, const GLvoid *);
    ...
    extern void glMap1d(GLenum, GLdouble, GLdouble, GLint, GLint,
			const GLdouble *);
    extern void glMap1f(GLenum, GLfloat, GLfloat, GLint, GLint,
			const GLfloat *);
    ...
    extern void glNormalPointer(GLenum, GLsizei, const GLvoid *);
    ...
    extern void glTexCoordPointer(GLint, GLenum, GLsizei, const GLvoid *);
    ...
    extern void glVertexPointer(GLint, GLenum, GLsizei, const GLvoid *);
